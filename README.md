...
- `use-cases/intraday-defense/`：Intraday Holding Defense Runtime governance read-model type contract（types + 靜態安全 constants，無 runtime；盤中防守 states / trigger rules / cooldown / dedup / no-DANGER guard / runtime readiness 治理語義）。
